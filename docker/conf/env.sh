...
MESSENGER_LOW_PRIORITY_PATH=${MESSENGER_LOW_PRIORITY_PATH:-"/%2f/low_priority"}
MESSENGER_LOW_PRIORITY_QUERY_PARAMS=${MESSENGER_LOW_PRIORITY_QUERY_PARAMS:-"?auto_setup=false"}
MESSENGER_FAILURE_PATH=${MESSENGER_FAILURE_PATH:-"/%2f/failed"}
MESSENGER_FAILURE_QUERY_PARAMS=${MESSENGER_FAILURE_QUERY_PARAMS:-"?auto_setup=false"}
...
export MESSENGER_TRANSPORT_LOW_PRIORITY_DSN="${MESSENGER_TRANSPORT_DSN:-"${MESSENGER_PROTOCOL}://${MESSENGER_USER}:${MESSENGER_PASSWORD}@${MESSENGER_HOST}:${MESSENGER_PORT}${MESSENGER_LOW_PRIORITY_PATH}${MESSENGER_LOW_PRIORITY_QUERY_PARAMS}"}"
export MESSENGER_TRANSPORT_FAILURE_DSN="${MESSENGER_TRANSPORT_DSN:-"${MESSENGER_PROTOCOL}://${MESSENGER_USER}:${MESSENGER_PASSWORD}@${MESSENGER_HOST}:${MESSENGER_PORT}${MESSENGER_FAILURE_PATH}${MESSENGER_FAILURE_QUERY_PARAMS}"}"
unset MESSENGER_PROTOCOL MESSENGER_USER MESSENGER_PASSWORD MESSENGER_HOST MESSENGER_PORT MESSENGER_PATH MESSENGER_QUERY_PARAMS MESSENGER_LOW_PRIORITY_PATH MESSENGER_LOW_PRIORITY_QUERY_PARAMS MESSENGER_FAILURE_PATH MESSENGER_FAILURE_QUERY_PARAMS
...
export S3_CDN_URL=${S3_CDN_URL:-"https://assets.shop.delta4x4.com"}
